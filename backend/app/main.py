...
allowed_origins = os.getenv(
    "CORS_ORIGINS",
    "http://localhost:5173,http://127.0.0.1:5173,http://localhost:3000,http://127.0.0.1:3000,https://tru-sight-ai.onrender.com,https://true-sight-ai.onrender.com,https://tru-sight-ai.onrender.com/,https://true-sight-ai.onrender.com/"
).split(",")
